...
print('Prazer em te conhecer {:^20}!'.format(nome)) #nome alinhado no meio em 20 espaços 
print('Prazer em te conhecer {:=^20}!'.format(nome)) #nome alinhado no meio em 20 espaços com '=' em volta
